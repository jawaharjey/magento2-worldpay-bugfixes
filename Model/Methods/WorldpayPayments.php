...
class WorldpayPayments extends AbstractMethod
{
    ...
    public function setupWorldpay($store_id = null) {
        if ($store_id)
        {
            $service_key = $this->config->getServiceKey(ScopeInterface::SCOPE_STORE, $store_id);
        }
        else
        {
    ...
    public function refund(InfoInterface $payment, $amount)
    {
        if ($order = $payment->getOrder()) {
            ...
            $worldpay = $this->setupWorldpay($store_id);
            try {
